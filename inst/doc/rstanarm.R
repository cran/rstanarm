...
## ----criticism, fig.width=10, fig.cap="Posterior predictive boxplots vs. observed datapoints"----
...
## ----loo_plot, fig.width=7, fig.height=4---------------------------------
...
## ---- Rhat-fit, results='hide', warning=TRUE-----------------------------
