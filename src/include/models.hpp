...
linkinv_bern(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& eta,
    ...
    try {
        {
            Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,1>  pi(static_cast<Eigen::VectorXd::Index>(rows(eta)));
            (void) pi;  // dummy to suppress unused var warning
            stan::math::initialize(pi, std::numeric_limits<double>::quiet_NaN());
...
ll_bern_lp(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& eta0,
    ...
    try {
        ...
        if (as_bool(logical_eq(link,1))) {
            ...
            {
                Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,1>  log_pi0(static_cast<Eigen::VectorXd::Index>(get_base1(N,1,"N",1)));
            ...
            {
                Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,1>  log_pi1(static_cast<Eigen::VectorXd::Index>(get_base1(N,2,"N",1)));
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        context__.validate_dims("data initialization", "u_X0", "int", context__.to_vec(((get_base1(N,1,"N",1) + 1) * (1 - dense_X))));
        validate_non_negative_index("u_X0", "((get_base1(N,1,\"N\",1) + 1) * (1 - dense_X))", ((get_base1(N,1,"N",1) + 1) * (1 - dense_X)));
        u_X0 = std::vector<int>(((get_base1(N,1,"N",1) + 1) * (1 - dense_X)),int(0));
        vals_i__ = context__.vals_i("u_X0");
        pos__ = 0;
        size_t u_X0_limit_0__ = ((get_base1(N,1,"N",1) + 1) * (1 - dense_X));
        ...
        context__.validate_dims("data initialization", "u_X1", "int", context__.to_vec(((get_base1(N,2,"N",1) + 1) * (1 - dense_X))));
        validate_non_negative_index("u_X1", "((get_base1(N,2,\"N\",1) + 1) * (1 - dense_X))", ((get_base1(N,2,"N",1) + 1) * (1 - dense_X)));
        u_X1 = std::vector<int>(((get_base1(N,2,"N",1) + 1) * (1 - dense_X)),int(0));
        vals_i__ = context__.vals_i("u_X1");
        pos__ = 0;
        size_t u_X1_limit_0__ = ((get_base1(N,2,"N",1) + 1) * (1 - dense_X));
        ...
        weights0 = vector_d(static_cast<Eigen::VectorXd::Index>((get_base1(N,1,"N",1) * has_weights)));
        ...
        weights1 = vector_d(static_cast<Eigen::VectorXd::Index>((get_base1(N,2,"N",1) * has_weights)));
        ...
        offset0 = vector_d(static_cast<Eigen::VectorXd::Index>((get_base1(N,1,"N",1) * has_offset)));
        ...
        offset1 = vector_d(static_cast<Eigen::VectorXd::Index>((get_base1(N,2,"N",1) * has_offset)));
        ...
        for (int k0__ = 0; k0__ < ((get_base1(N,1,"N",1) + 1) * (1 - dense_X)); ++k0__) {
        ...
        for (int k0__ = 0; k0__ < ((get_base1(N,2,"N",1) + 1) * (1 - dense_X)); ++k0__) {
        ...
        stan::math::fill(t_any_124, std::numeric_limits<int>::min());
        stan::math::fill(t_all_124, std::numeric_limits<int>::min());
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        for (int i0__ = 0U; i0__ < has_intercept; ++i0__)
            try {
            writer__.scalar_ub_unconstrain((logical_eq(link,4) ? 0.0 : positive_infinity() ),gamma[i0__]);
        } catch (const std::exception& e) { 
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        for (size_t k_0__ = 0; k_0__ < dim_gamma_0__; ++k_0__) {
            if (jacobian__)
                gamma.push_back(in__.scalar_ub_constrain((logical_eq(link,4) ? 0.0 : positive_infinity() ),lp__));
            else
                gamma.push_back(in__.scalar_ub_constrain((logical_eq(link,4) ? 0.0 : positive_infinity() )));
        }
        ...
        try {
            {
                ...
                if (as_bool(logical_eq(prior_dist,1))) {
                    ...
                    if (as_bool(t_all_124)) {
                        ...
                        for (int k = 1; k <= K; ++k) {
                            if (as_bool((primitive_value((primitive_value(logical_eq(get_base1(prior_df,k,"prior_df",1),1)) || primitive_value(logical_eq(get_base1(prior_df,k,"prior_df",1),2)))) || primitive_value(logical_eq(get_base1(prior_df,k,"prior_df",1),4))))) {
                                lp_accum__.add(normal_log(get_base1(z_beta,k,"z_beta",1),0,1));
                            } else {
                                lp_accum__.add(student_t_log(get_base1(z_beta,k,"z_beta",1),get_base1(prior_df,k,"prior_df",1),0,1));
                            }
                        }
                    } else {
                        lp_accum__.add(student_t_log(z_beta,prior_df,0,1));
                    }
                } else if (as_bool(logical_eq(prior_dist,3))) {
                    lp_accum__.add(normal_log(z_beta,0,1));
                    ...
                    lp_accum__.add(inv_gamma_log(get_base1(global,2,"global",1),0.5,0.5));
                } else if (as_bool(logical_eq(prior_dist,4))) {
                    lp_accum__.add(normal_log(z_beta,0,1));
                    lp_accum__.add(normal_log(get_base1(local,1,"local",1),0,1));
                    lp_accum__.add(inv_gamma_log(get_base1(local,2,"local",1),multiply(0.5,prior_df),multiply(0.5,prior_df)));
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        context__.validate_dims("data initialization", "u_X", "int", context__.to_vec(((N + 1) * (1 - dense_X))));
        validate_non_negative_index("u_X", "((N + 1) * (1 - dense_X))", ((N + 1) * (1 - dense_X)));
        u_X = std::vector<int>(((N + 1) * (1 - dense_X)),int(0));
        vals_i__ = context__.vals_i("u_X");
        pos__ = 0;
        size_t u_X_limit_0__ = ((N + 1) * (1 - dense_X));
        ...
        weights = vector_d(static_cast<Eigen::VectorXd::Index>((N * has_weights)));
        ...
        offset = vector_d(static_cast<Eigen::VectorXd::Index>((N * has_offset)));
        ...
        for (int k0__ = 0; k0__ < ((N + 1) * (1 - dense_X)); ++k0__) {
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        sqrt_y = vector_d(static_cast<Eigen::VectorXd::Index>((N * logical_eq(family,3))));
        validate_non_negative_index("log_y", "(N * logical_eq(family,3))", (N * logical_eq(family,3)));
        log_y = vector_d(static_cast<Eigen::VectorXd::Index>((N * logical_eq(family,3))));
        sum_log_y = double(0);
        hs = int(0);
        len_z_T = int(0);
        len_var_group = int(0);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        for (int i0__ = 0U; i0__ < has_intercept; ++i0__)
            try {
            writer__.scalar_lb_unconstrain(((primitive_value(logical_eq(family,1)) || primitive_value(logical_eq(link,2))) ? negative_infinity() : 0.0 ),gamma[i0__]);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable gamma: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        for (size_t k_0__ = 0; k_0__ < dim_gamma_0__; ++k_0__) {
            if (jacobian__)
                gamma.push_back(in__.scalar_lb_constrain(((primitive_value(logical_eq(family,1)) || primitive_value(logical_eq(link,2))) ? negative_infinity() : 0.0 ),lp__));
            else
                gamma.push_back(in__.scalar_lb_constrain(((primitive_value(logical_eq(family,1)) || primitive_value(logical_eq(link,2))) ? negative_infinity() : 0.0 )));
        }
        ...
        try {
            {
                ...
                if (as_bool((primitive_value(logical_eq(has_weights,0)) && primitive_value(logical_eq(prior_PD,0))))) {
                    if (as_bool(logical_eq(family,1))) {
                        ...
                        lp_accum__.add(GammaReg(y,eta,dispersion,link,sum_log_y, pstream__));
                    } else {
                        lp_accum__.add(inv_gaussian(y,linkinv_inv_gaussian(eta,link, pstream__),dispersion,sum_log_y,sqrt_y, pstream__));
                    }
                } else if (as_bool(logical_eq(prior_PD,0))) {
                    {
                ...
                if (as_bool(logical_gt(prior_scale_for_dispersion,0))) {
                    lp_accum__.add(cauchy_log(dispersion_unscaled,0,1));
                }
                if (as_bool(logical_eq(prior_dist,1))) {
                    lp_accum__.add(normal_log(z_beta,0,1));
                } else if (as_bool(logical_eq(prior_dist,2))) {
...
linkinv_count(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& eta,
    ...
    try {
        {
            Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,1>  phi(static_cast<Eigen::VectorXd::Index>(rows(eta)));
    ...
    try {
        {
            Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,1>  ll(static_cast<Eigen::VectorXd::Index>(rows(eta)));
            (void) ll;  // dummy to suppress unused var warning
            Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,1>  rho(static_cast<Eigen::VectorXd::Index>(rows(eta)));
            (void) rho;  // dummy to suppress unused var warning
            stan::math::initialize(ll, std::numeric_limits<double>::quiet_NaN());
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        for (int i0__ = 0U; i0__ < has_intercept; ++i0__)
            try {
            writer__.scalar_lb_unconstrain((logical_eq(link,1) ? negative_infinity() : 0.0 ),gamma[i0__]);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable gamma: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        for (size_t k_0__ = 0; k_0__ < dim_gamma_0__; ++k_0__) {
            if (jacobian__)
                gamma.push_back(in__.scalar_lb_constrain((logical_eq(link,1) ? negative_infinity() : 0.0 ),lp__));
            else
                gamma.push_back(in__.scalar_lb_constrain((logical_eq(link,1) ? negative_infinity() : 0.0 )));
        }
        ...
        try {
            {
                ...
                if (as_bool((primitive_value(logical_eq(has_weights,0)) && primitive_value(logical_eq(prior_PD,0))))) {
                    if (as_bool(logical_neq(family,2))) {
                        ...
                        if (as_bool(logical_eq(link,1))) {
                            lp_accum__.add(neg_binomial_2_log_log(y,eta,get_base1(dispersion,1,"dispersion",1)));
                        } else {
                            lp_accum__.add(neg_binomial_2_log(y,linkinv_count(eta,link, pstream__),get_base1(dispersion,1,"dispersion",1)));
                        }
                    }
                ...
                if (as_bool(logical_eq(family,3))) {
                    lp_accum__.add(gamma_log(get_base1(noise,1,"noise",1),get_base1(dispersion,1,"dispersion",1),1));
                }
                if (as_bool(logical_gt(t,0))) {
                    decov_lp(z_b,z_T,rho,zeta,tau,regularization,delta,shape,t,p, lp__, lp_accum__, pstream__);
                }
                ...
                if (as_bool(logical_eq(prior_PD,0))) {
                    {
                        ...
                        stan::math::assign(dummy, ll_mvn_ols_qr_lp(get_base1(theta,j,"theta",1),get_base1(Rb,j,"Rb",1),(logical_eq(has_intercept,1) ? (get_base1(alpha,j,"alpha",1) + shift) : shift ),get_base1(ybar,j,"ybar",1),get_base1(SSR,j,"SSR",1),get_base1(sigma,j,"sigma",1),get_base1(N,j,"N",1), lp__, lp_accum__, pstream__));
                    }
                }
            }
            ...
            for (int j = 1; j <= J; ++j) {
                {
                    ...
                    stan::math::initialize(shift, std::numeric_limits<double>::quiet_NaN());
                    stan::math::assign(shift, dot_product(get_base1(xbarR_inv,j,"xbarR_inv",1),get_base1(theta,j,"theta",1)));
                    stan::math::assign(get_base1_lhs(mean_PPD,j,"mean_PPD",1), normal_rng((logical_eq(has_intercept,1) ? (get_base1(alpha,j,"alpha",1) + shift) : shift ),(get_base1(sigma,j,"sigma",1) * get_base1(sqrt_inv_N,j,"sqrt_inv_N",1)), base_rng__));
...
make_cutpoints(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& probabilities,
    ...
    try {
        {
            Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,1>  cutpoints(static_cast<Eigen::VectorXd::Index>((rows(probabilities) - 1)));
...
public:
    ...
    void write_array(RNG& base_rng__,
        ...
        (void) zeta;  // dummy to suppress unused var warning
        vector_d mean_PPD(static_cast<Eigen::VectorXd::Index>(((logical_gt(J,2) * (J - 1)) + 1)));
        (void) mean_PPD;  // dummy to suppress unused var warning
        vector_d residuals(static_cast<Eigen::VectorXd::Index>((N * do_residuals)));
